...
```bash
curl -fsSL https://raw.githubusercontent.com/drascom/mqtt-device-monitor/main/manage.sh | sudo bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/drascom/mqtt-device-monitor/main/manage.sh | bash -s -- --uninstall
```

If you installed with sudo (on Linux), use:

```bash
curl -fsSL https://raw.githubusercontent.com/drascom/mqtt-device-monitor/main/manage.sh | sudo bash -s -- --uninstall
```
...
```bash
# Start the service
sudo systemctl start mqtt-device-monitor@<username>.service

# Stop the service
sudo systemctl stop mqtt-device-monitor@<username>.service

# Check status
sudo systemctl status mqtt-device-monitor@<username>.service

# View logs
journalctl -u mqtt-device-monitor@<username>.service -f
```
...
# Stop the service
launchctl unload ~/Library/LaunchAgents/com.mqtt-device-monitor.plist
